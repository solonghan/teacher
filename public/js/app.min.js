...
(function () {
  ...
  function getLanguage() {
    ...
    var request = new XMLHttpRequest(); // Instantiating the request object

    request.open("GET", 'assets/lang/' + language + '.json'); // Defining event listener for readystatechange event
  ...
  function pluginData() {
    ...
    choicesExamples.forEach(function (item) {
      ...
      if (isChoicesVal["data-choices-multiple-default"]) {// choiceData.removeItemButton=true
      }

      if (isChoicesVal["data-choices-multiple-groups"]) {// choiceData.removeItemButton=true
      }
  ...
  function twoColumnMenuGenerate() {
    ...
    if (defaultValues && (isTwoColumn == "twocolumn" || defaultValues['data-layout'] == 'twocolumn')) {
      ...
      document.getElementById("two-column-menu").innerHTML = ul.outerHTML; // show submenu on sidebar menu click
  ...
  function toggleHamburgerMenu() {
    var windowSize = document.documentElement.clientWidth;
    if (windowSize > 767) document.querySelector(".hamburger-icon").classList.toggle('open'); //For collapse horizontal menu
  ...
  function setDefaultAttribute() {
    if (!sessionStorage.getItem('defaultAttribute')) {
      ...
      layoutSwitch(isLayoutAttributes); // open right sidebar on first time load
  ...
  function init() {
    ...
    initComponents();
    initMenuItemScroll(); // resetLayout();

    pluginData(); // initLanguage();
