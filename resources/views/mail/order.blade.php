...
<div style="width: 205mm;">
    ...
    <table style="width: 100%; margin-bottom: 10px;" border="0">
        ...
        <tr>
            <td colspan="2" style="font-size: 14px;">
                ...
                <br>
                <strong>付款方式：</strong> {{ $user->transaction_method() }}<br>
    ...
    <table style="width: 100%;border: 1px solid #CCC;font-size: 15px;border-collapse: collapse;text-align: center;" border="1" cellpadding="2">
        <tr>
            <td colspan="4" style="font-size: 20px;font-weight: normal;text-align:center;background: #1173BA;color: white;padding: 5px;">{{ $title }}</td>
        </tr>
        <tr>
            <td>產品</td>
            <td>單價</td>
        ...
        <tr>
            <td style="width: 150px;">
                <div style="width:100%; font-size: 18px; text-align:center; background:#1173BA; border-radius:4px; padding: 8px 15px; text-decoration:none; color:#FFF;  mso-line-height-rule:exactly; line-height:30px;">
                    <a height="30" href="{{ route('mgr.order') }}">
    ...
    <!-- <div style="font-size: 18px; text-align:center;">
        <a height="30" href="{{ route('mgr.order') }}" style="background:#1173BA; border-radius:4px; border: 1px solid #0163AA; padding: 8px 15px; text-decoration:none; color:#FFF;  mso-line-height-rule:exactly; line-height:30px;">
            <span style="text-decoration:none;">前往訂單列表»</span>
        </a>
    </div> -->
    @endif
