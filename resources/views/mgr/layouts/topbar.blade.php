                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" src="@if (Auth::guard('mgr')->user()->avatar != ''){{ URL::asset('images/' . Auth::guard('mgr')->user()->avatar) }}@else{{ URL::asset('assets/images/users/avatar.svg') }}@endif"
                                alt="Header Avatar">
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">{{Auth::guard('mgr')->user()->username}}</span>
                                <span class="d-none d-xl-block ms-1 fs-12 text-muted user-name-sub-text">{{Auth::guard('mgr')->user()->privilege->title}}</span>
                            </span>
                        </span>
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <form id="logout-form" action="{{ route('mgr.logout') }}" method="POST" style="display: none;">
                            @csrf
                        </form>
                    </div>
                </div>
