            ...
            success: function(data) {
                ...
                if (data.status) {
                   ...
                   if(data.title=='企業(含私立學校)'){
                    ...
                    $('.old_unit_name_input').append($('<input type="text" class="form-control" id="old_unit" name="old_unit"><br><br>'));
