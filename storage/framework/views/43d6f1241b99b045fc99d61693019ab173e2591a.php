                    ...
                    <div class="card mt-4">
                        ...
                        <div class="card-body p-4">
                            <div class="text-center mt-2">
                                <h5 class="text-primary">北教外校推薦系統後台</h5>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('ID_number', 'admin')); ?>" id="username" name="ID_number" placeholder="Enter username">
...
<?php echo $__env->make('mgr.layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ntue_teacher_0509\resources\views/mgr/auth/login.blade.php ENDPATH**/ ?>