<tr data-id="<?php echo e($item['id']); ?>">
    ...
    <td>
        ...
        <?php if(!isset($item['priv_edit_specialty']) || $item['priv_edit_specialty']): ?>
        <button class="btn btn-sm btn-primary edit_specialty-item-btn">編輯</button>
        <?php endif; ?>

        <?php if(!isset($item['priv_del_specialty']) || $item['priv_del_specialty']): ?>
        <button class="btn btn-sm btn-danger del_specialty-item-btn">刪除</button>
        <?php endif; ?>

    </td>
</tr><?php /**PATH C:\xampp\htdocs\ntue_teacher_0509\resources\views/mgr/items/specialty_item.blade.php ENDPATH**/ ?>