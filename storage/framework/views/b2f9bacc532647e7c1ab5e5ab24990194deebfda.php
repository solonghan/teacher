                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" src="<?php if(Auth::guard('mgr')->user()->avatar != ''): ?><?php echo e(URL::asset('images/' . Auth::guard('mgr')->user()->avatar)); ?><?php else: ?><?php echo e(URL::asset('assets/images/users/avatar.svg')); ?><?php endif; ?>"
                                alt="Header Avatar">
...
</header><?php /**PATH C:\xampp\htdocs\ntue_teacher_0509\resources\views/mgr/layouts/topbar.blade.php ENDPATH**/ ?>